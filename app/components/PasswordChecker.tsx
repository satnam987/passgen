  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-5 border border-gray-100 space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="text-lg font-semibold text-black">Password Security Check</h3>
      </div>
          ...
          <div className="mt-4 space-y-3">
            <div className="flex flex-col p-4 rounded-lg border">
              <div className="flex justify-between items-center mb-2">
                <h4 className="font-medium text-black">Password security:</h4>
              ...
              <p className="text-sm text-gray-800">{result.strength.feedback}</p>
            </div>
            ...
            {result.isCompromised && (
              <div className="p-3 bg-indigo-50 rounded-lg border border-indigo-100">
                <h4 className="font-medium text-black mb-2">Tips for a better password:</h4>
